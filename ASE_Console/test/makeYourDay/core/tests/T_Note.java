...
class T_Note {
	...
	public void testWrongWrite() {
		...
		String errorMessage = "Incorrect note text length: To mutch symbols! Note length cant be greater than " + String.valueOf(note.MAX_TEXT_LENGTH)+". Was "+String.valueOf(TO_LONG_CONTENT_STRING.length())+" symbols.";
